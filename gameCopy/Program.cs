...
namespace Task02
{
    ...
    { ' ', k, ' ' , ' ' }};
        ...
        static void instructions()
        {
            ...
            Console.WriteLine("It is a game of seconds try to keep away from walls and enemy");
        ...
        static void gameoverCollsion(player heroCo)
        {
